...
//    @IBOutlet fileprivate var txtfGroupName: AXGroupChatTextField!
//    
...
//                        weakSelf.groupDelegate.createGroupGetFriendInGroupList(friendsSelected: weakSelf.groupList, groupName: groupName, groupImgUrl: urlString, friendsAdded: weakSelf.addedList)
//                    } else {
//                        //error
//                        hud.hide(animated: true)
