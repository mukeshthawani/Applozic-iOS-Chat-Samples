//
//  ShareLocationBaseViewController.swift
//  Axiata
//
//  Created by appsynth on 1/18/17.
...
class ShareLocationBaseViewController: ALBaseViewController {
    ...
    private lazy var locationManager: CLLocationManager = CLLocationManager.initializeLocationManager(delegate: self)
...
//        Logger.debug(message: "move to \(toLocation)")
...
//                Logger.debug(message: "No myLocation")
                return
            }
...
extension ShareLocationBaseViewController: GMSMapViewDelegate {
...
//                Logger.debug(message: "move to myLocation \(loc.coordinate)")
...
//        switch status {
//        case .restricted:
////            Logger.verbose(message: "Change: Location access was restricted.")
//        case .denied:
////            Logger.verbose(message: "Change: User denied access to location.")
//        case .notDetermined:
////            Logger.verbose(message: "Change: Location status not determined.")
//        case .authorizedAlways: fallthrough
//        case .authorizedWhenInUse:
////            Logger.verbose(message: "Change: Location status is OK.")
//        }
    }
