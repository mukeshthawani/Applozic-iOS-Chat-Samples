...
final class CustomCameraPreviewViewController: ALBaseViewController {
    
    // MARK: - Variables and Types
    private var customCamDelegate:CustomCameraProtocol!
    var image: UIImage!
    ...
    // MARK: - Lifecycle
    static func instance(with image: UIImage) -> CustomCameraPreviewViewController {
        let viewController: CustomCameraPreviewViewController = UIStoryboard(storyboard: .camera).instantiateViewController()
...
extension CustomCameraPreviewViewController: UIScrollViewDelegate {
