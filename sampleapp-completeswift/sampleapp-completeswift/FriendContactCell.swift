...
final class FriendContactCell: UITableViewCell {
    ...
    func update(viewModel: FriendViewModel, isExistingFriend: Bool = false) {
    ...
    private func setupCheckmark(isSelect: Bool) {
        imgView.image = isSelect ? UIImage(named: "icon_checked"): nil
    }
